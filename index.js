...
(lib.ВерсияСлайдерbackup = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(26).to({y:269.6},0).wait(1).to({y:297.5},0).wait(1).to({y:325.4},0).wait(1).to({y:353.3},0).wait(1).to({y:381.2},0).wait(1).to({y:409.1},0).wait(1).to({y:437},0).wait(1).to({y:464.8},0).wait(1).to({y:492.7},0).wait(1).to({y:520.6},0).wait(1).to({y:548.5},0).wait(1).to({y:576.4},0).to({_off:true},1).wait(179));
